...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.type_show = QtWidgets.QLineEdit(self.layoutWidget_2)
        self.type_show.setObjectName("type_show")
        self.gridLayout_3.addWidget(self.type_show, 1, 1, 1, 1)
        self.type = QtWidgets.QLabel(self.layoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.type.setFont(font)
        self.type.setObjectName("type")
        self.gridLayout_3.addWidget(self.type, 1, 0, 1, 1)
...
#............................part2...........................
    ...
    def calbmi(self):
        ...
        if(bmiresult<18):
            ...
            bmiid = 5
        print("haha")
        comment = callbmicomment(bmiid)
        btype = callbmitype(bmiid)
        btype = btype[1:]
        btype = btype[:-1]
        print(btype)
        print(bmiresult)
        ...
        self.type_show.setPlaceholderText(btype)
        self.result_show.setPlaceholderText(comment)
        uid = self.loginfun()
        print(uid)
        sendbackresult(bmiid,uid)
...
def callbmitype(id):
    mydb = ConnectorMysql()
    mycursor = mydb.cursor()
    sql = ("SELECT bmitype FROM bmicare WHERE bmiid="+str(id)+";")
    mycursor.execute(sql)
    myresult = str(mycursor.fetchall())
    finalresult = myresult[2:]
    finalresult = finalresult[:-3]
